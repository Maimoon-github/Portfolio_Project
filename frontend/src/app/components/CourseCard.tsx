...
//             </h2>
//             <p className="mt-4" style={{ color: "#9199A5" }}>
//               Difficulty: {detailedCourse.difficulty}
//             </p>
//             <p className="mt-2" style={{ color: "#9199A5" }}>
//               Estimated Hours: {detailedCourse.estimated_hours}
//             </p>
//             {detailedCourse.description && (
//               <p className="mt-4 text-sm leading-relaxed" style={{ color: "#9199A5" }}>
//                 {detailedCourse.description}
//               </p>
//             )}
//             <div className="mt-6">
...
//                 <ul className="list-disc list-inside mt-2 space-y-1" style={{ color: "#9199A5" }}>
//                   {detailedCourse.lessons.map((lesson: Lesson) => (
