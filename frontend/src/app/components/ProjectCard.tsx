...
// //           // Inside BlogCard
// //         <span className="text-xs text-[#9199A5]">
// //             {post.category.name} • {new Date(post.published_date).toLocaleDateString()} • {post.read_time} min read
// //         </span>
// //           // Tags
// //         <div className="flex gap-1">
// //             {post.tags.map(tag => (
// //               <span key={tag.id} className="tech-tag">{tag.name}</span>
// //             ))}
// //         </div> 
