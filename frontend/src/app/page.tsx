  ...
  return (
    <div className="overflow-hidden bg-background text-foreground">
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(255,216,115,0.32),_transparent_32%),linear-gradient(180deg,_rgba(255,255,255,0.96),_rgba(255,255,255,0.82))]" />
        <div className="relative mx-auto flex max-w-7xl flex-col gap-16 px-5 py-16 sm:px-8 lg:px-10 xl:py-20">
          <div className="grid gap-10 lg:grid-cols-[1.85fr_1.15fr] lg:items-center">
            <div className="max-w-2xl">
              <span className="mb-6 inline-flex rounded-full bg-slate-900/5 px-4 py-2 text-[0.65rem] font-semibold uppercase tracking-[0.3em] text-slate-800 dark:bg-slate-700/15 dark:text-slate-100">
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <a
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-7 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-slate-900 transition hover:border-amber-300 hover:bg-amber-50"
                >
                  View Portfolio
                </a>
              </div>
            ...
            <div className="relative mx-auto w-full max-w-md overflow-hidden rounded-[2rem] border border-amber-200/30 bg-gradient-to-br from-slate-50 via-white to-slate-100 p-6 shadow-[0_40px_120px_rgba(15,23,42,0.12)] dark:border-slate-800/50 dark:bg-slate-900/70 sm:max-w-xl">
              ...
              <div className="relative overflow-hidden rounded-[1.75rem] bg-slate-950 p-5 text-white shadow-2xl shadow-slate-950/20">
                <div className="h-72 rounded-3xl bg-[radial-gradient(circle_at_center,_rgba(255,209,77,0.35),_rgba(49,132,253,0.15),_rgba(15,23,42,0.95))]" />
              </div>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              accent: "bg-amber-100/80 text-amber-900",
            },
            {
              ...
              accent: "bg-sky-100/80 text-sky-900",
            },
            {
              ...
              accent: "bg-emerald-100/80 text-emerald-900",
            },
          ].map((item) => (
            <article key={item.title} className="rounded-3xl border border-slate-200/70 bg-white/85 p-6 shadow-sm shadow-slate-900/5 backdrop-blur-sm dark:border-slate-800/60 dark:bg-slate-950/80">
      ...
      <section className="mx-auto max-w-7xl px-5 pb-20 sm:px-8 lg:px-10">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2">
          <article className="group overflow-hidden rounded-[2rem] bg-slate-950 text-white shadow-2xl shadow-slate-950/10 transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-950/20">
          ...
          <div className="grid gap-5">
            <article className="overflow-hidden rounded-[2rem] bg-slate-950 text-white shadow-2xl shadow-slate-950/10 transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-950/20">
            ...
            <article className="grid gap-5 sm:grid-cols-2">
              <div className="rounded-[2rem] border border-slate-200/70 bg-white/90 p-6 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/85">
                <span className="inline-flex rounded-full bg-slate-900/5 px-3 py-1 text-xs uppercase tracking-[0.25em] text-slate-700 dark:bg-slate-200/5 dark:text-slate-200">
                  Cultural
                </span>
                <h3 className="mt-4 text-2xl font-semibold tracking-tight text-slate-950 dark:text-white">Ether Museum</h3>
              </div>
              <div className="rounded-[2rem] border border-slate-200/70 bg-white/90 p-6 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/85">
                <span className="inline-flex rounded-full bg-amber-100 px-3 py-1 text-xs uppercase tracking-[0.25em] text-amber-900">
                  Hospitality
                </span>
                <h3 className="mt-4 text-2xl font-semibold tracking-tight text-slate-950 dark:text-white">Aura Retreat</h3>
              </div>
            </article>
          </div>
        </div>
      ...
      <section className="bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.8),_rgba(46,100,98,0.03))] py-20">
        <div className="mx-auto max-w-5xl px-5 text-center sm:px-8 lg:px-10">
          ...
          <div className="mx-auto mt-10 flex max-w-xl flex-col gap-4 sm:flex-row sm:justify-center">
            <input
              ...
              className="w-full rounded-full border border-slate-200 bg-white px-5 py-4 text-sm text-slate-900 shadow-sm outline-none transition focus:border-amber-300 focus:ring-2 focus:ring-amber-200 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
            />
