...
export default function PokemonCatchRateCalculator() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700;800&display=swap');
        .poke-calc, .poke-calc * { box-sizing: border-box; }
        .poke-calc input[type=range] { -webkit-appearance: none; appearance: none; background: transparent; }
        .poke-calc input[type=range]::-webkit-slider-thumb { -webkit-appearance: none; }
        .poke-calc::-webkit-scrollbar { width: 4px; } .poke-calc::-webkit-scrollbar-track { background:#081A04; }
        .poke-calc::-webkit-scrollbar-thumb { background:#2D4A35; border-radius:2px; }
        @keyframes fadeUp { from{opacity:0;transform:translateY(12px)} to{opacity:1;transform:translateY(0)} }
        @keyframes pulse { 0%,100%{opacity:1} 50%{opacity:0.6} }
        .calc-card { animation: fadeUp 0.4s ease both; }
        .poke-sel:hover { border-color: #A4FBCC !important; }
      ...
      <div className="poke-calc" style={S.root}>
        <div style={S.container}>
