...
function ProjectModalContent({ slug, onClose }: ModalContentProps) {
  const { project, loading } = useProject(slug);  // use slug
      ...
      <div className="p-6 pt-5">
        ...
        {(project.demo || project.github) && (
          ...
          >
            ...
            {/* Full detail page link — use slug */}
            <a
...
export function Projects() {
  ...
  const [selectedSlug, setSelectedSlug] = useState<string | null>(null);  // changed from selectedId
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {projects.map((project, idx) => (
                ...
                >
                  <ProjectCard
                    project={project}
                    onClick={() => setSelectedSlug(project.slug)}  // pass slug
                  />
                </div>
              ))}
            </div>
